...
class LstmMask(BasicModel):
    ...
    def __train__(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            train_sent_0, train_sent_0_len, train_sent_1, train_sent_1_len, train_label, train_sent_0_mask, train_sent_1_mask, train_sent_0_intent = self.data_deal(
                train_data)

            dev_sent_0, dev_sent_0_len, dev_sent_1, dev_sent_1_len, dev_label, dev_sent_0_mask, dev_sent_1_mask, dev_0_intent = self.data_deal(
                dev_data)
